    ...
    for fold_name in fold_dirs:
        ...
        try:
            results = evaluate_segmentation_performance(
                ...
                tumor_label_only=True # Added tumor_label_only=True to ensure Dice is calculated only for label 1.
            )
...
# Added tumor_label_only parameter to control binarization logic.
...
if __name__ == "__main__":
    ...
    parser.add_argument("--fold_separate", action="store_true", help="Run nnunet evaluation and report PANTHER metrics for each fold separately.")
    ...
    if args.fold_separate:
        ...
        ## Couldnt completely implement with the classic evaluation, for normal purposes please use evaluate_local.py ##
